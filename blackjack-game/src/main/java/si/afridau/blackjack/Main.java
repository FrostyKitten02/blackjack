...
import si.afridau.blackjack.strategy.AlmostPerfectStrategy;
...
public class Main {
    ...
    private static void almostPrfectStrat() {
        final int DECKS = 6;
        final int ROUNDS = 60;

        Dealer dealer = new Dealer(DECKS);
        IStrategy strategy = new AlmostPerfectStrategy(DeckUtil.getTotalCards(DECKS), dealer);
